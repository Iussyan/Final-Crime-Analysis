                                                        ...
                                                        <tbody class="table-light">
                                                            <?php foreach ($recentIncidents as $incident): ?>
                                                                <tr>
                                                                    ...
                                                                    <td class="text-break"><?= $incident['Address'] ?></td>
                                                                    <td class="text-break"><?= $incident['Street'] ?></td>
                                                                    <td><?= $incident['Date'] ?></td>
                                                                    <td><?= $incident['Time'] ?></td>
                                                                    <td><?= $incident['Crime Category'] ?></td>
                                                                    <td class="text-break"><?= $incident['Crime Type'] ?></td>
                                                                    <td class="text-break"><?= $incident['Crime Description'] ?></td>
                                                                    <td><?= $incident['Witness Name'] ?></td>
                                                                    <td><?= $incident['Witness Age'] ?></td>
                                                                    <td><?= $incident['Witness Sex'] ?></td>
                                                                    <td><?= $incident['Contact Number'] ?></td>
                                                                </tr>
                                                            <?php endforeach; ?>
                                                        </tbody>
                                                    </table>
