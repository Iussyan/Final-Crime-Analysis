                                        ...
                                        <div class="modal-body p-4">
                                            <form id="crime-form" action="../secure/add_crime_data.php" method="POST">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6 mb-3">
                                                        <div class="form-floating">
                                                            <label for="witness_name" class="float-label">Victim's Name</label>
                                                            <input type="text" class="form-control" id="witness_name" name="witness_name" required>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6 mb-3">
                                                        <div class="form-floating">
                                                            <label for="witness_age" class="float-label">Victim's Age</label>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6 mb-3">
                                                        <div class="form-floating">
                                                            <label for="witness_sex" class="float-label">Victim's Sex</label>
