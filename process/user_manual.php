                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-8">
                                        <div class="page-header-title">
                                            ...
                                            <p class="lead mb-0">
                                                A useful collection of knowledge for navigating the system
                                            </p>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <ul class="breadcrumb-title">
                                            ...
                                            <li class="breadcrumb-item">
                                                <a href="user_manual.php"><i class="ti-book"></i> User Manual</a>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="container-fluid mt-4 px-4">
                            ...
                            <div class="card shadow border-0 rounded">
                                <div class="card-header">
                                    <h5 class="card-header-text">User Manual</h5>
                                </div>
                                    ...
                                    <div class="accordion" role="tablist" id="userManualAccordion" aria-multiselectable="true">
                                        ...
                                        <div class="accordion-panel">
                                            ...
                                            <div id="collapseOne" class="panel-collapse in collapse" role="tabpanel" aria-labelledby="headingOne" >
                                                <div class="accordion-content accordion-desc">
                                                    <p>
                                                        To begin using the system, users must first log in using their provided credentials. Once authenticated, users are directed to the main dashboard. The dashboard offers a concise overview of crime summaries and geospatial mapping, presented through an intuitive charm navigation bar. From here, users can either delve deeper into specific statistics by clicking summary widgets or proceed to the crime reporting section for data entry and management.
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="accordion-panel">
                                            <div class="accordion-heading" role="tab" id="headingTwo">
                                                <h6 class="card-title accordion-title">
                                                    <a class="accordion-msg waves-effect waves-dark scale_active collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapseTwo" aria-expanded="false" aria-controls="collapseOne">
                                                        2. Reporting, Editing, and Archiving Crime Data
                                                    </a>
                                                </h6>
                                            </div>
                                            <div id="collapseTwo" class="panel-collapse in collapse" role="tabpanel" aria-labelledby="headingTwo" >
                                                <div class="accordion-content accordion-desc">
                                                    <p>
                                                        Within the "Crime Reporting" section, users are able to add new crime entries by specifying the location via a dynamic map, selecting the appropriate crime category and type, and providing additional details such as date, time, and a description. Victim details including name and age are required, with contact number being optional. Existing entries can also be edited or archived. Archived records are not deleted but retained with a status label for audit and reference purposes.
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="accordion-panel">
                                            ...
                                            <div id="collapseSix" class="panel-collapse in collapse" role="tabpanel" aria-labelledby="headingSix" >
                                                <div class="accordion-content accordion-desc">
                                                    <p>
