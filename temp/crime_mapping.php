                                    ...
                                    <div class="page-body">
                                        <div class="row">
                                            <div id="map-container" class="container-fluid p-0 position-relative" style="height: 73vh; overflow: hidden;">
                                                ...
                                                <!-- Map Controls Panel -->
                                                <div id="map-controls" class="position-absolute top-0 end-0 p-3 d-flex flex-column align-items-end" style="z-index: 1000;">
                                                    <button class="btn btn-light shadow-sm mb-2" id="zoom-in-btn" title="Zoom In">
                                                        <i class="bi bi-plus-circle"></i> Zoom In
                                                    </button>
                                                    <button class="btn btn-light shadow-sm mb-2" id="zoom-out-btn" title="Zoom Out">
...
<![endif]-->
    ...
    <!-- Script Dependencies -->
    <script src="../javascript/map-full-stack.js?v=2"></script>
