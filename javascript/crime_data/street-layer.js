...
const streetLayer = L.geoJSON(null, {
  ...
  onEachFeature: function (feature, layer) {
    ...
    layer.on("click", (e) => {
      ...
      document.getElementById("selected-street-name").textContent =
        props.name || "Unnamed";
      document.getElementById("selected-street-id").textContent =
        props["@id"] || "";
      document.getElementById("selectedStreetName").value =
        props.name || "Unnamed";
