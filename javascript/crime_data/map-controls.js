// REMOVE THE COMMENT LINES IN ORDER TO USE THE OPTIONAL SEARCH FUNCTION!
...
toggleMarkerButton.onAdd = function () {
  ...
  div.innerHTML =
    '<button id="toggle-marker" title="Toggle Marker" class="map-button"><img src="../src/images/marker-on-icon.png" alt="Toggle Marker" style="width:20px;height:20px;"></button>';
  return div;
};
